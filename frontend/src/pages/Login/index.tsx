...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const isLogged = await login(formattedUserName, password);
  ...
  return (
    <div className="flex justify-center">
      ...
      >
        ...
        <IText id="username" placeholder="Usuário" value={username} setValue={setUsername} disabled={loading} />
        <IText id="password" type="password" placeholder="Senha" value={password} setValue={setPassword} disabled={loading} />
        <Button
          label="Entrar"
          type="submit"
          className="bg-green-600 p-2 text-gray-300 hover:bg-green-500 w-[196.8px] m-auto"
          loading={loading}
        />
